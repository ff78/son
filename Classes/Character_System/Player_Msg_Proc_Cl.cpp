...
/**************************************** dely *************************************/
/*------------------- send -------------------*/
bool Player_Msg_Proc::send_chat_all_msg(int channel, const char* receiver_name, const char* chat)//«¯”Ú
{
	//int character_id = (int)para[0];
	//Game_Data::Character* character = CHARACTER_MGR::instance()->get_character(character_id);
	//if (!character)
...
bool Player_Msg_Proc::send_chat_private_msg(int channel, const char* receiver_name, const char* chat)//ÀΩ√‹
{
	//vector<uint64> para;
	//gm_interface.get_para(para);
	//if (para.size() < 1)
...
bool Player_Msg_Proc::send_chat_team_msg(int channel, const char* receiver_name, const char* chat)//◊È∂”
{
	return false;

}

bool Player_Msg_Proc::send_chat_friend_msg(int channel, const char* receiver_name, const char* chat)//∫√”—
{
	return false;
}

bool Player_Msg_Proc::send_chat_faction_msg(int channel, const char* receiver_name, const char* chat)//π§ª·
{
	int player_id = Account_Data_Mgr::instance()->get_current_role_id();
	if (!player_id)
		return false;
...
bool Player_Msg_Proc::send_chat_world_msg(int channel, const char* receiver_name, const char* chat)// ¿ΩÁ
{
	int player_id = Account_Data_Mgr::instance()->get_current_role_id();
	if (!player_id)
		return false;
...
/*------------------- receive -------------------*/
bool Player_Msg_Proc::receive_chat_all_msg(Game_Logic::Game_Interface& gm_interface)//«¯”Ú
{
	message_stream body_ms((char*)gm_interface.get_buff(), gm_interface.get_buff_size());
	body_ms.set_rd_ptr(sizeof(int));
...
bool Player_Msg_Proc::receive_chat_private_msg(Game_Logic::Game_Interface& gm_interface)//ÀΩ√‹
{
	message_stream body_ms((char*)gm_interface.get_buff(), gm_interface.get_buff_size());
	body_ms.set_rd_ptr(sizeof(int));
	int player_id_received;
...
bool Player_Msg_Proc::receive_chat_team_msg(Game_Logic::Game_Interface& gm_interface)//◊È∂”
{
	message_stream body_ms((char*)gm_interface.get_buff(), gm_interface.get_buff_size());
	body_ms.set_rd_ptr(sizeof(int));
	int player_id_received;
...
bool Player_Msg_Proc::receive_chat_friend_msg(Game_Logic::Game_Interface& gm_interface)//∫√”—
{
	message_stream body_ms((char*)gm_interface.get_buff(), gm_interface.get_buff_size());
	body_ms.set_rd_ptr(sizeof(int));
	int player_id_received;
...
bool Player_Msg_Proc::receive_chat_faction_msg(Game_Logic::Game_Interface& gm_interface)//π§ª·
{
	message_stream body_ms((char*)gm_interface.get_buff(), gm_interface.get_buff_size());
	body_ms.set_rd_ptr(sizeof(int));
	int player_id_received;
...
bool Player_Msg_Proc::receive_chat_world_msg(Game_Logic::Game_Interface& gm_interface)// ¿ΩÁ
{
	int player_id = Account_Data_Mgr::instance()->get_current_role_id();
	Game_Data::Player* player = dynamic_cast<Game_Data::Player*>(CHARACTER_MGR::instance()->get_character(player_id));
	if (!player)
